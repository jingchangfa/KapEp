...
public class KapPermissionUtils {
    private static final String TAG = KapPermissionUtils.class.getSimpleName();
    ...
    public static void goSetingActivity(Activity context){
        Intent intent = new Intent(Settings.ACTION_LOCATION_SOURCE_SETTINGS);
        context.startActivity(intent);//前往设置页
    }
    /**
     * Requests permission.
     *
